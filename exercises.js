...
function moneyTrain(speed){
  if (speed < 50){
    ...
    return "13. " + "Now you ballin' in the Shinkansen!";
  }
}
...
var newBal = budget - doughnutPrice;
function buyDoughnut(){
 return newBal, doughnutBought++;
}
buyDoughnut();
console.log("My new budget is " + newBal + " and I have " + doughnutBought + " doughnuts.");
buyDoughnut();
console.log("My new budget is " + newBal + " and I have " + doughnutBought + " doughnuts.");
